...
-- Database: `rental`
--
USE `rental`;  /* <--- PERBAIKAN: Memilih database tujuan */
...
CREATE TABLE `accounts` (
  ...
  `NIK` int(18) NOT NULL,
  PRIMARY KEY (`id`), /* PRIMARY KEY ditetapkan di sini */
  UNIQUE KEY `username_unique` (`username`) /* Tambahkan UNIQUE KEY untuk username */
...
CREATE TABLE `car` (
  `id_mobil` int(11) NOT NULL, /* Kolom yang akan jadi AUTO_INCREMENT */
  ...
  PRIMARY KEY (`id_mobil`), /* PERBAIKAN: id_mobil harus jadi Primary Key */
  UNIQUE KEY `plat_mobil_unique` (`plat_mobil`) /* plat_mobil dijadikan Unique Key */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
/* Indeks untuk Foreign Key yang hilang ditambahkan di sini */
